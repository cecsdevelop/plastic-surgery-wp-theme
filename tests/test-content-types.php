...
try {
    ...
    check('single EN por slug nativo (sin traducción de slug) y permalink en EN', (bool) preg_match('/<title>SEO (&#038;|&amp;) Technical Marketing/', $curl('/en/services/test-seo-marketing/')) && $front('idml_set_current_language("en"); echo get_permalink(' . $svc2 . ');') === 'http://localhost:8888/Intelindev/en/services/test-seo-marketing/');
