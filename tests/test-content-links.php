...
try {
    echo "1) función pura\n";
    $f = 'pswpt_resolve_root_relative_urls';
    ...
    update_post_meta($page_id, pswpt_POST_TRANSLATED_CONTENT_META, [
        'es' => ['[test-links-hero cta_text="Servicios" cta_url="/servicios/"]', '<p><a class="tl-raw" href="/contacto/">Contacto</a> <a class="tl-abs" href="https://pswpt.com/x/">abs</a></p>'],
    ...
    update_option('pswpt_header_settings', ['cta_type' => 'modal', 'cta_text' => ['es' => 'Hablemos'], 'cta_modal_title' => ['es' => 'Escribinos'], 'cta_modal_content' => '<p><a class="tl-modal" href="/contacto/">c</a></p>']);
    ...
    check('absoluta intacta', strpos($es, 'class="tl-abs" href="https://pswpt.com/x/"') !== false);
    ...
    $modal = json_decode((string) shell_exec('curl -s ' . escapeshellarg('http://localhost:8888/WPfemsculpt/wp-json/pswpt/v1/modal?lang=es')), true);
